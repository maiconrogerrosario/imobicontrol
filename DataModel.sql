...
CREATE TABLE `owner` (
  ...
  `updated_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  key owner_application (`application_id`),
  FULLTEXT KEY `full_text` (`name`,`address_street`,`address_number`,`address_complement`,`address_postalcode`,`address_city`,`address_state`,`address_country`),
  CONSTRAINT `owner_application` FOREIGN KEY (`application_id`) REFERENCES `application` (`id`) ON DELETE CASCADE ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `teste` (
  ...
  `updated_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  key property_application (`application_id`),
  key property_owner (`owner_id`),
  FULLTEXT KEY `full_text` (`address_street`,`address_number`,`address_postalcode`,`address_city`,`address_state`,`address_country`),
  CONSTRAINT `property_application` FOREIGN KEY (`application_id`) REFERENCES `application` (`id`) ON DELETE CASCADE ON UPDATE NO ACTION,
  CONSTRAINT `property_owner` FOREIGN KEY (`owner_id`) REFERENCES `owner` (`id`) ON DELETE CASCADE ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
